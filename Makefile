# This Makefile is for the Esol::GetEnv extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Esol/GetEnv.pm]
#     AUTHOR => [q[root <root@>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[Esol::GetEnv]
#     PREREQ_PM => {  }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Esol/GetEnv.pm]
...
PARENT_NAME = Esol
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Esol/GetEnv.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
INST_LIBDIR      = $(INST_LIB)/Esol
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Esol
...
TO_INST_PM = lib/Esol/GetEnv.pm

PM_TO_BLIB = lib/Esol/GetEnv.pm \
	blib/lib/Esol/GetEnv.pm
...
DISTNAME = Esol-GetEnv
DISTVNAME = Esol-GetEnv-1
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: Esol-GetEnv' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Esol-GetEnv",' >> META_new.json
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Esol/GetEnv.pm blib/lib/Esol/GetEnv.pm 
